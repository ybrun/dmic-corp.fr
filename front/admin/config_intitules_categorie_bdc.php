...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dmic_knowbaseitemcategories WHERE id_categorie=%s",
...
mysql_select_db($database_dmic, $dmic);
$query_categories = "SELECT dmic_knowbaseitemtypecategorie.name_type, dmic_knowbaseitemcategories.type_categorie, dmic_knowbaseitemcategories.name_categorie, dmic_knowbaseitemcategories.comment_categorie, dmic_knowbaseitemcategories.id_categorie FROM dmic_knowbaseitemcategories, dmic_knowbaseitemtypecategorie WHERE dmic_knowbaseitemcategories.type_categorie =dmic_knowbaseitemtypecategorie.id ORDER BY dmic_knowbaseitemcategories.type_categorie, dmic_knowbaseitemcategories.name_categorie";
$categories = mysql_query($query_categories, $dmic) or die(mysql_error());
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
  <h1 align="center"><span class="Style7">Configuration des intitul&eacute;s : cat&eacute;gorie de base de connaissance.</span></h1>
  <p align="center">&nbsp;</p>
...
<input name="add" value="Rechercher" class="submit" onClick="document.location=document.getElementById(&quot;menu_nav&quot;).value;" type="submit">
  ...
  <p align="center">&nbsp;</p>
  <p align="left">
    <a href="http://www.dmic-corp.fr/front/admin/new_categorie_bdc.php"><input type="submit" name="Nouvelle catégorie de base de connaissance" id="Nouvelle catégorie de base de connaissance" value="Nouvelle cat&eacute;gorie de base de connaissance"></a>
  </p>
  <p align="center">&nbsp;</p>
  <table width="1000" border="1" align="center" class="tab_cadrehov">
    <tr>
      <th width="281" scope="col"><div align="center">Type de cat&eacute;gorie</div></th>
      <th width="283" scope="col"><div align="center">Nom de la cat&eacute;gorie</div></th>
      <th width="354" scope="col"><div align="center">Commentaires</div></th>
      <th width="32" scope="col">&nbsp;</th>
      <th width="16" scope="col">&nbsp;</th>
    </tr>
    <?php do { ?>
      <tr>
        <th scope="row"><div align="center"><?php echo $row_categories['name_type']; ?></div></th>
        <th scope="row"><div align="center"><?php echo $row_categories['name_categorie']; ?></div></th>
        <td><div align="justify"><?php echo $row_categories['comment_categorie']; ?></div></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/modif_categorie_bdc.php?id=<?php echo $row_categories['id_categorie']; ?>"><img src="/images/modif.png" width="32" height="32"></a></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/config_intitules_categorie_bdc.php?id=<?php echo $row_categories['id_categorie']; ?>"><img src="/images/delete2.png" width="16" height="16"></a></td>
      </tr>
