...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dmic_type_actualite WHERE id=%s",
...
mysql_select_db($database_dmic, $dmic);
$query_type_actualite = "SELECT * FROM dmic_type_actualite ORDER BY type_actualite ASC";
$type_actualite = mysql_query($query_type_actualite, $dmic) or die(mysql_error());
$row_type_actualite = mysql_fetch_assoc($type_actualite);
$totalRows_type_actualite = mysql_num_rows($type_actualite);
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
  <h1 align="center"><span class="Style7">Configuration des intitul&eacute;s : type d'actualit&eacute;s.</span></h1>
  <p align="center">&nbsp;</p>
...
<input name="add" value="Rechercher" class="submit" onClick="document.location=document.getElementById(&quot;menu_nav&quot;).value;" type="submit">
  ...
  <p align="center">&nbsp;</p>
  <p align="left">
    <a href="http://www.dmic-corp.fr/front/admin/new_types_actualites.php"><input type="submit" name="Nouveau type actualite" id="Nouveau type actualite" value="Nouveau type d'actualit&eacute;s"></a>
  </p>
  <p align="center">&nbsp;</p>
  <table width="711" border="1" align="center" class="tab_cadrehov">
    ...
    <?php do { ?>
      <tr>
        <th scope="row"><div align="center"><?php echo $row_type_actualite['type_actualite']; ?></div></th>
        <td><div align="justify"><?php echo $row_type_actualite['commentaire']; ?></div></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/modif_types_actualites.php?id=<?php echo $row_type_actualite['id']; ?>"><img src="/images/modif.png" width="32" height="32"></a></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/config_intitules_types_actualites.php?id=<?php echo $row_type_actualite['id']; ?>"><img src="/images/delete2.png" width="16" height="16"></a></td>
      </tr>
      <?php } while ($row_type_actualite = mysql_fetch_assoc($type_actualite)); ?>
  </table>
  <p align="center">&nbsp;</p>
  <!-- end .content -->
<!-- InstanceEndEditable --></div>
...
mysql_free_result($type_actualite);
?>
