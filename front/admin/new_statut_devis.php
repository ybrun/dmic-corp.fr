...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "new_staut_devis")) {
  $insertSQL = sprintf("INSERT INTO dmic_devisstatut (statut, commentaire) VALUES (%s, %s)",
  ...
  $insertGoTo = "http://www.dmic-corp.fr/front/admin/config_intitules_statut_devis.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
    ...
    <h2 align="center" class="Style7">Ajout d'un Statut de Devis.</h2>
  <p align="center">&nbsp;</p>
  <form action="<?php echo $editFormAction; ?>" method="POST" name="new_staut_devis" id="new_staut_devis">
    <label></label>
...
<div class='center spaced'><textarea name='commentaire' cols='100' rows='30' id='commentaire' onBlur="MM_validateForm('answer','','R');return document.MM_returnValue"></textarea>
    ...
    <input type="hidden" name="MM_insert" value="new_staut_devis" />
    <!-- fin de #mainContent -->
  </form>
  <h1 class="Style7"></h1>
  <h1 class="Style7"></h1>
