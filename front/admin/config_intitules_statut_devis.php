...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dmic_devisstatut WHERE id_statut=%s",
...
mysql_select_db($database_dmic, $dmic);
$query_statut_devis = "SELECT * FROM dmic_devisstatut ORDER BY statut ASC";
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
  <h1 align="center"><span class="Style7">Configuration des intitul&eacute;s : profil utilisateur.</span></h1>
  <p align="center">&nbsp;</p>
...
<input name="add" value="Rechercher" class="submit" onClick="document.location=document.getElementById(&quot;menu_nav&quot;).value;" type="submit">
  ...
  <p align="center">&nbsp;</p>
  <p align="left">
    <a href="http://www.dmic-corp.fr/front/admin/new_statut_devis.php"><input type="submit" name="Nouveau statut de devis" id="Nouveau statut de devis" value="Nouveau statut de devis"></a>
  </p>
  <p align="center">&nbsp;</p>
  <table width="711" border="1" align="center" class="tab_cadrehov">
    <tr>
      <th width="281" scope="col"><div align="center">Nom du statut</div></th>
    ...
    <?php do { ?>
      <tr>
        <th scope="row"><div align="center"><?php echo $row_statut_devis['statut']; ?></div></th>
        <td><div align="justify"><?php echo $row_statut_devis['commentaire']; ?></div></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/modif_statut_devis.php?id=<?php echo $row_statut_devis['id_statut']; ?>"><img src="/images/modif.png" width="32" height="32"></a></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/config_intitules_statut_devis.php?id=<?php echo $row_statut_devis['id_statut']; ?>"><img src="/images/delete2.png" width="16" height="16"></a></td>
      </tr>
      <?php } while ($row_statut_devis = mysql_fetch_assoc($statut_devis)); ?>
  </table>
  <p align="center">&nbsp;</p>
  <!-- end .content -->
<!-- InstanceEndEditable --></div>
