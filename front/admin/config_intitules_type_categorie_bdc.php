...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dmic_knowbaseitemtypecategorie WHERE id=%s",
...
mysql_select_db($database_dmic, $dmic);
$query_type_categorie_bdc = "SELECT * FROM dmic_knowbaseitemtypecategorie ORDER BY name_type ASC";
$type_categorie_bdc = mysql_query($query_type_categorie_bdc, $dmic) or die(mysql_error());
$row_type_categorie_bdc = mysql_fetch_assoc($type_categorie_bdc);
$totalRows_type_categorie_bdc = mysql_num_rows($type_categorie_bdc);
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
  <h1 align="center"><span class="Style7">Configuration des intitul&eacute;s : type de cat&eacute;gorie de base de connaissances.</span></h1>
  <p align="center">&nbsp;</p>
...
<input name="add" value="Rechercher" class="submit" onClick="document.location=document.getElementById(&quot;menu_nav&quot;).value;" type="submit">
  ...
  <p align="center">&nbsp;</p>
  <p align="left">
    <a href="http://www.dmic-corp.fr/front/admin/new_type_categorie_bdc.php"><input type="submit" name="Nouveau type categorie bdc" id="Nouveau type categorie bdc" value="Nouveau type de cat&eacute;gorie de base de connaissance"></a>
  </p>
  <p align="center">&nbsp;</p>
  <table width="711" border="1" align="center" class="tab_cadrehov">
    ...
    <?php do { ?>
      <tr>
        <th scope="row"><div align="center"><?php echo $row_type_categorie_bdc['name_type']; ?></div></th>
        <td><div align="justify"><?php echo $row_type_categorie_bdc['commentaire_type']; ?></div></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/modif_type_categorie_bdc.php?id=<?php echo $row_type_categorie_bdc['id']; ?>"><img src="/images/modif.png" width="32" height="32"></a></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/config_intitules_type_categorie_bdc.php?id=<?php echo $row_type_categorie_bdc['id']; ?>"><img src="/images/delete2.png" width="16" height="16"></a></td>
      </tr>
      <?php } while ($row_type_categorie_bdc = mysql_fetch_assoc($type_categorie_bdc)); ?>
  </table>
  <p align="center">&nbsp;</p>
  <!-- end .content -->
<!-- InstanceEndEditable --></div>
...
mysql_free_result($type_categorie_bdc);
?>
