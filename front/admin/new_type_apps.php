...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "new_type_apps")) {
  $insertSQL = sprintf("INSERT INTO dmic_appstype (apps_type_name, appstype_description) VALUES (%s, %s)",
  ...
  $insertGoTo = "http://www.dmic-corp.fr/front/admin/config_intitules_type_apps.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
    ...
    <h2 align="center" class="Style7">Ajout d'un type d'applications.</h2>
    <p align="center">&nbsp;</p>
    <form action="<?php echo $editFormAction; ?>" method="POST" name="new_type_apps" id="new_type_apps">
      <label></label>
...
<div class='center spaced'><textarea name='commentaire_type' cols='100' rows='30' id='commentaire_type' onBlur="MM_validateForm('answer','','R');return document.MM_returnValue"></textarea>
      ...
      <label> </label>
      <input type="hidden" name="MM_insert" value="new_type_apps" />
    </form>
    <h1 class="Style5"></h1>
<!-- InstanceEndEditable --></div>
