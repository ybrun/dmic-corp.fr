...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "new_profils_users")) {
  $insertSQL = sprintf("INSERT INTO dmic_profils_users (name_profils, commentaire) VALUES (%s, %s)",
  ...
  $insertGoTo = "http://www.dmic-corp.fr/front/admin/config_intitules_profils_users.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
    ...
    <h2 align="center" class="Style7">Ajout d'un Profil.</h2>
  <p align="center">&nbsp;</p>
  <form action="<?php echo $editFormAction; ?>" method="POST" name="new_profils_users" id="new_profils_users">
    <label></label>
    <table width="300" border="1" align="center" bordercolor="#92BEE1" class="tab_cadrehov">
      <tr>
        <th bordercolor="#92BEE1" scope="col"><div align="right" class="Style7">Nom</div></th>
        <td bordercolor="#92BEE1" scope="col"><label>
          <input name="name" type="text" id="name" size="100" />
          </label></td>
        </tr>
      <tr>
        <th bordercolor="#92BEE1" scope="row"><div align="right" class="Style7">Commentaire</div></th>
...
<div class='center spaced'><textarea name='commentaire' cols='100' rows='30' id='commentaire' onBlur="MM_validateForm('answer','','R');return document.MM_returnValue"></textarea>
    ...
    <input type="hidden" name="MM_insert" value="new_profils_users" />
    <!-- end .content -->
  </form>
<!-- InstanceEndEditable --></div>
