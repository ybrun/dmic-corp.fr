...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "new_type_actualite")) {
  $insertSQL = sprintf("INSERT INTO dmic_type_actualite (type_actualite, commentaire) VALUES (%s, %s)",
                       GetSQLValueString($_POST['name_type_actualite'], "text"),
                       GetSQLValueString($_POST['commentaire_type_actualite'], "text"));

  mysql_select_db($database_dmic, $dmic);
  $Result1 = mysql_query($insertSQL, $dmic) or die(mysql_error());

  $insertGoTo = "http://www.dmic-corp.fr/front/admin/config_intitules_types_actualites.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
    ...
    <h2 align="center" class="Style7">Ajout d'un type d'actualit&eacute;.</h2>
    <p align="center">&nbsp;</p>
    <form action="<?php echo $editFormAction; ?>" method="POST" name="new_type_actualite" id="new_type_actualite">
      <label></label>
      <table width="300" border="1" align="center" bordercolor="#92BEE1" class="tab_cadrehov">
        <tr>
          <th bordercolor="#92BEE1" class="Style4" scope="col"><div align="right" class="Style7">Nom</div></th>
          <td bordercolor="#92BEE1" scope="col"><label>
            <input name="name_type_actualite" type="text" id="name_type_actualite" size="100" />
            </label></td>
        </tr>
        <tr>
          <th bordercolor="#92BEE1" class="Style4" scope="row"><div align="right" class="Style7">Commentaire</div></th>
          <td bordercolor="#92BEE1"><label>
<script language='javascript' type='text/javascript'>tinyMCE.init({
         language : 'fr',
         mode : 'exact',
         elements: 'commentaire_type',
         valid_elements: '*[*]',
...
<div class='center spaced'><textarea name='commentaire_type' cols='100' rows='30' id='commentaire_type' onBlur="MM_validateForm('answer','','R');return document.MM_returnValue"></textarea>
</div>
            </label></td>
        </tr>
        <tr>
      ...
      <label> </label>
      <input type="hidden" name="MM_insert" value="new_section_site" />
      <input type="hidden" name="MM_insert" value="new_type_actualite" />
    </form>
    <h1 class="Style5">&nbsp;</h1>
  <h1>&nbsp;</h1>
  <!-- end .content -->
