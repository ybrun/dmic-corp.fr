...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dmic_modele_pc WHERE ID=%s",
...
mysql_select_db($database_dmic, $dmic);
$query_modele_devis_pc = "SELECT * FROM dmic_modele_pc ORDER BY name_modele ASC";
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
  <h1 align="center"><span class="Style7">Configuration des intitul&eacute;s : mod&egrave;le de PC.</span></h1>
  <p align="center">&nbsp;</p>
...
<input name="add" value="Rechercher" class="submit" onClick="document.location=document.getElementById(&quot;menu_nav&quot;).value;" type="submit">
  ...
  <p align="center">&nbsp;</p>
  <p align="left">
    <a href="http://www.dmic-corp.fr/front/admin/new_modele_pc.php"><input type="submit" name="Nouveau modele de PC" id="Nouveau modele de PC" value="Nouveau mod&egrave;le de PC"></a>
  </p>
  <p align="center">&nbsp;</p>
  <table width="711" border="1" align="center" class="tab_cadrehov">
    ...
    <?php do { ?>
      <tr>
        <th scope="row"><div align="center"><?php echo $row_modele_devis_pc['name_modele']; ?></div></th>
        <td><div align="justify"><?php echo $row_modele_devis_pc['description_modele']; ?></div></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/modif_modele_pc.php?id=<?php echo $row_modele_devis_pc['ID']; ?>"><img src="/images/modif.png" width="32" height="32"></a></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/config_intitules_modele_pc.php?id=<?php echo $row_modele_devis_pc['ID']; ?>"><img src="/images/delete2.png" width="16" height="16"></a></td>
      </tr>
