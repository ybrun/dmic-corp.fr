...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dmic_profils_users WHERE id=%s",
...
<input name="add" value="Rechercher" class="submit" onClick="document.location=document.getElementById(&quot;menu_nav&quot;).value;" type="submit">
  ...
  <p align="center">&nbsp;</p>
  <p align="left">
    <a href="http://www.dmic-corp.fr/front/admin/new_profils_users.php"><input type="submit" name="Nouveau profil user" id="Nouveau profil user" value="Nouveau profil utilisateur"></a>
  </p>
  <p align="center">&nbsp;</p>
  <table width="711" border="1" align="center" class="tab_cadrehov">
    <tr>
      <th width="281" scope="col"><div align="center">Nom du profil</div></th>
    ...
    <?php do { ?>
      <tr>
        <th scope="row"><div align="center"><?php echo $row_profil['name_profils']; ?></div></th>
        <td><div align="justify"><?php echo $row_profil['commentaire']; ?></div></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/modif_profils_users.php?id=<?php echo $row_profil['id']; ?>"><img src="/images/modif.png" width="32" height="32"></a></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/config_intitules_profils_users.php?id=<?php echo $row_profil['id']; ?>"><img src="/images/delete2.png" width="16" height="16"></a></td>
      </tr>
