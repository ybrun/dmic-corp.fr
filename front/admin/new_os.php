...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "new_os")) {
  $insertSQL = sprintf("INSERT INTO dmic_os (name, `description`) VALUES (%s, %s)",
  ...
  $insertGoTo = "http://www.dmic-corp.fr/front/admin/config_intitules_os.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
    ...
    <h2 align="center" class="Style7">Ajout d'un Syst&egrave;me d'exploitation.</h2>
    <p align="center">&nbsp;</p>
  <form action="<?php echo $editFormAction; ?>" method="POST" name="new_os" id="new_os">
    <label></label>
    <table width="300" border="1" align="center" bordercolor="#92BEE1" class="tab_cadrehov">
      <tr>
        <th bordercolor="#92BEE1" scope="col"><div align="center">Nom</div></th>
        <th bordercolor="#92BEE1" scope="col"><div align="left"><label>
          <input name="name" type="text" id="name" size="100" />
          </label></div></th>
        </tr>
      <tr>
        <th bordercolor="#92BEE1" scope="row"><div align="center">Commentaire</div></th>
...
<div class='center spaced'><textarea name='commentaire' cols='100' rows='30' id='commentaire' onBlur="MM_validateForm('answer','','R');return document.MM_returnValue"></textarea>
    ...
    <input type="hidden" name="MM_insert" value="new_os">
    </form>
