...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "new_type_categorie")) {
  $insertSQL = sprintf("INSERT INTO dmic_knowbaseitemtypecategorie (name_type, commentaire_type) VALUES (%s, %s)",
                       GetSQLValueString($_POST['name_type'], "text"),
                       GetSQLValueString($_POST['commentaire_type'], "text"));

  mysql_select_db($database_dmic, $dmic);
  $Result1 = mysql_query($insertSQL, $dmic) or die(mysql_error());

  $insertGoTo = "http://www.dmic-corp.fr/front/admin/config_intitules_type_categorie_bdc.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
    ...
    <h2 align="center" class="Style7">Ajout d'un type de cat&eacute;gorie de base de connaissances.</h2>
    <p align="center">&nbsp;</p>
    <form action="<?php echo $editFormAction; ?>" method="POST" name="new_type_categorie" id="new_type_categorie">
      <label></label>
      <table width="300" border="1" align="center" bordercolor="#92BEE1" class="tab_cadrehov">
        <tr>
          ...
          <td bordercolor="#92BEE1" scope="col"><label>
            <input name="name_type" type="text" id="name_type" value="" size="100" />
            </label></td>
        </tr>
        <tr>
...
<div class='center spaced'><textarea name='commentaire_type' cols='100' rows='30' id='commentaire_type' onBlur="MM_validateForm('answer','','R');return document.MM_returnValue"></textarea>
      ...
      <label> </label>
      <input type="hidden" name="MM_insert" value="new_type_categorie" />
    </form>
    <h2 align="center" class="Style18"><!-- end .content --></h2>
<!-- InstanceEndEditable --></div>
