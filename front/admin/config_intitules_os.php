...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dmic_os WHERE id_os=%s",
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
  <h1 align="center"><span class="Style7">Configuration des intitul&eacute;s : syst&egrave;me d'exploitation.</span></h1>
  <p align="center">&nbsp;</p>
...
<input name="add" value="Rechercher" class="submit" onClick="document.location=document.getElementById(&quot;menu_nav&quot;).value;" type="submit">
  ...
  <p align="center">&nbsp;</p>
  <p align="left">
    <a href="http://www.dmic-corp.fr/front/admin/new_os.php"><input type="submit" name="Nouveau os" id="Nouveau os" value="Nouveau syst&egrave;me d'exploitation"></a>
  </p>
  <p align="center">&nbsp;</p>
  <table width="711" border="1" align="center" class="tab_cadrehov">
    ...
    <?php do { ?>
      <tr>
        <th scope="row"><div align="center"><?php echo $row_os['name']; ?></div></th>
        <td><div align="justify"><?php echo $row_os['description']; ?></div></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/modif_os.php?id=<?php echo $row_os['id_os']; ?>"><img src="/images/modif.png" width="32" height="32"></a></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/config_intitules_os.php?id=<?php echo $row_os['id_os']; ?>"><img src="/images/delete2.png" width="16" height="16"></a></td>
      </tr>
