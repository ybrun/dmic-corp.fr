...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dmic_modeledevispc WHERE id_modele=%s",
...
<div id="LayoutDiv4" class="content"><!-- InstanceBeginEditable name="content" -->
  <h1 align="center"><span class="Style7">Configuration des intitul&eacute;s : mod&egrave;le de devis de PC.</span></h1>
  <p align="center">&nbsp;</p>
...
<input name="add" value="Rechercher" class="submit" onClick="document.location=document.getElementById(&quot;menu_nav&quot;).value;" type="submit">
  ...
  <p align="center">&nbsp;</p>
  <p align="left">
    <a href="http://www.dmic-corp.fr/front/admin/new_modele_devis_pc.php"><input type="submit" name="Nouveau modele de devis de PC" id="Nouveau modele de devis de PC" value="Nouveau mod&egrave;le de devis de PC"></a>
  </p>
  <p align="center">&nbsp;</p>
  <table width="1000" border="1" align="center" class="tab_cadrehov">
    <tr>
      ...
      <th width="283" scope="col"><div align="center">Type d'ordinateur</div></th>
      <th width="354" scope="col"><div align="center">Cat&eacute;gorie d'ordinateur</div></th>
      <th width="32" scope="col">&nbsp;</th>
      <th width="16" scope="col">&nbsp;</th>
    </tr>
    <?php do { ?>
      <tr>
        <th scope="row"><div align="center"><?php echo $row_modele_devis_pc['name']; ?></div></th>
        <th scope="row"><div align="center"><?php echo $row_modele_devis_pc['pc_type']; ?></div></th>
        <td><div align="center"><?php echo $row_modele_devis_pc['pc_categorie']; ?></div></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/modif_modele_devis_pc.php?id=<?php echo $row_modele_devis_pc['id_modele']; ?>"><img src="/images/modif.png" width="32" height="32"></a></td>
        <td><a href="http://www.dmic-corp.fr/front/admin/config_intitules_modele_devis_pc.php?id=<?php echo $row_modele_devis_pc['id_modele']; ?>"><img src="/images/delete2.png" width="16" height="16"></a></td>
      </tr>
      <?php } while ($row_modele_devis_pc = mysql_fetch_assoc($modele_devis_pc)); ?>
  </table>
  <p align="center">&nbsp;</p>
  <!-- end .content -->
<!-- InstanceEndEditable --></div>
