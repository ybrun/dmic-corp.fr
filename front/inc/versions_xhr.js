 ...
 */
function actualiserVersions()
{
    var listeVersions = requete.responseText;
    var blocListe = document.getElementById('blocVersions');
    blocListe.innerHTML = listeVersions;
}
...
function getVersions(id_chapitres)
{
    ...
    else
    {
        ...
        var url = '../inc/versions.php?id_chapitres='+ id_chapitres;
