 ...
 */
function actualiserUsers()
{
    var listeUsers = requete.responseText;
    var blocListe = document.getElementById('blocUsers');
    blocListe.innerHTML = listeUsers;
}
...
function getUsers(name_profils)
{
    ...
    else
    {
        ...
        var url = '../inc/users.inc.php?name_profils='+ name_profils;
