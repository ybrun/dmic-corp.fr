 ...
 */
function actualiserActuscategorieslvl2()
{
    var listeActuscategorieslvl2 = requete.responseText;
    var blocListe = document.getElementById('blocActuscategorieslvl2');
    blocListe.innerHTML = listeActuscategorieslvl2;
}
...
function getActuscategorieslvl2(id_oeuvres)
{
    ...
    else
    {
        ...
        var url = '../inc/actuscategorieslvl2.php?id_oeuvres='+ id_oeuvres;
