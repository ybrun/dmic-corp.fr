 ...
 */
function actualiserCycles()
{
    var listeCycles = requete.responseText;
    var blocListe = document.getElementById('blocCycles');
    blocListe.innerHTML = listeCycles;
}
...
function getCycles(idt)
{
    ...
    else
    {
        ...
        var url = '../inc/cycles.php?idt='+ idt;
