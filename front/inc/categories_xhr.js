...
{
    var listeCategories = requete.responseText;
    var blocListe = document.getElementById('blocCategories');
    blocListe.innerHTML = listeCategories;
}
...
function getCategories(idt)
{
    ...
    else
    {
        ...
        var url = 'inc/categories_bdc.php?idt='+ idt;
