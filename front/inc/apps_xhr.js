 ...
 */
function actualiserApps()
{
    var listeApps = requete.responseText;
    var blocListe = document.getElementById('blocApps');
    blocListe.innerHTML = listeApps;
}
...
function getApps(idt)
{
    ...
    else
    {
        ...
        var url = 'inc/apps.inc.php?idt='+ idt;
