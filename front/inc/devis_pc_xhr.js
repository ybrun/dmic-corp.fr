 ...
 */
function actualiserDevisPc()
{
    var listeDevisPc = requete.responseText;
    var blocListe = document.getElementById('blocDevisPc');
    blocListe.innerHTML = listeDevisPc;
}
...
function getDevisPc(id_modele)
{
    ...
    else
    {
        ...
        var url = 'inc/devis_pc.inc.php?id_modele='+ id_modele;
