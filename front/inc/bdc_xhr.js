 ...
 */
function actualiserBdC()
{
    var listeBdC = requete.responseText;
    var blocListe = document.getElementById('blocBdC');
    blocListe.innerHTML = listeBdC;
}
...
function getOeuvres(id_categorie)
{
    ...
    else
    {
        ...
        var url = 'inc/bdc.php?id_categorie='+ id_categorie;
