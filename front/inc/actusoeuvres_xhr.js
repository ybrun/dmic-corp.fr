 ...
 */
function actualiserActusoeuvres()
{
    var listeActusoeuvres = requete.responseText;
    var blocListe = document.getElementById('blocActusoeuvres');
    blocListe.innerHTML = listeActusoeuvres;
}
...
function getActusoeuvres(idt)
{
    ...
    else
    {
        ...
        var url = '../inc/actusoeuvres.php?idt='+ idt;
