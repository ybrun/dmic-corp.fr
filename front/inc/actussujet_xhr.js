 ...
 */
function actualiserActussujet()
{
    var listeActussujet = requete.responseText;
    var blocListe = document.getElementById('blocActussujet');
    blocListe.innerHTML = listeActussujet;
}
...
function getActussujet(id_lvl2)
{
    ...
    else
    {
        ...
        var url = '../inc/actussujet.php?id_lvl2='+ id_lvl2;
