 ...
 */
function actualiserChapitres()
{
    var listeChapitres = requete.responseText;
    var blocListe = document.getElementById('blocChapitres');
    blocListe.innerHTML = listeChapitres;
}
...
function getChapitres(id_oeuvres)
{
    ...
    else
    {
        ...
        var url = '../inc/chapitres.php?id_oeuvres='+ id_oeuvres;
