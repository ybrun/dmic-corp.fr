...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "new_categorie")) {
  $insertSQL = sprintf("INSERT INTO dmic_cycleoeuvres (type, cycle_name, cycle_commentaire) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['types'], "text"),
                       GetSQLValueString($_POST['cycle_name'], "text"),
...
mysql_select_db($database_dmic, $dmic);
$query_type = "SELECT * FROM dmic_typeoeuvres ORDER BY type_name ASC";
...
?>
  ...
  <div class="content" id="LayoutDiv3">
    <table width="100%" border="0" class="tab_cadrehov">
      <tr>
  ...
  <h2 align="center" class="Style7">Nouveau cycle d'une oeuvre.</h2>
  <p align="center">&nbsp;</p>
  ...
  <form action="<?php echo $editFormAction; ?>" method="POST" name="new_categorie" id="new_categorie">
    <label></label>
    <table width="300" border="1" align="center" bordercolor="#92BEE1">
      <tr>
...
?>
      ...
      <tr>
        ...
        <th bordercolor="#92BEE1" scope="col"><div align="left">
          <input name="cycle_name" type="text" id="cycle_name" value="" size="100" />
        </div></th>
      </tr>
      <tr>
