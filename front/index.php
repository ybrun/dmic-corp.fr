...
$query_news = "SELECT * FROM dmic_actualites WHERE dmic_actualites.`date` like '2014%' ORDER BY `date` DESC";
...
<p align="center">&nbsp;</p>
  <?php if ($_SESSION['MM_UserGroup']=='Administrateurs' or $_SESSION['MM_UserGroup']=='Contributeurs' or $_SESSION['MM_UserGroup']=='Formateurs') { ?><a href="http://www.dmic-corp.fr/front/contribute/new_actualite.php"><input type="submit" name="Nouvelle actualité" id="Nouvelle actualité" value="Nouvelle actualit&eacute;" class="submit">
  </a><?php } ?>
<p align="center">&nbsp;</p>
